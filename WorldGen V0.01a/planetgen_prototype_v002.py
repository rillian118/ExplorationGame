...
TERRAIN_FG_COLORS: Dict[int, str] = {
    TerrainCode.DEEP_LIQUID: "[34m",      # blue
    TerrainCode.SHALLOW_LIQUID: "[36m",   # cyan
    TerrainCode.ICE: "[97m",              # bright white
    TerrainCode.LOWLAND: "[32m",          # green
    TerrainCode.PLAINS: "[92m",           # bright green
    TerrainCode.HIGHLANDS: "[33m",        # yellow/brown
    TerrainCode.MOUNTAINS: "[37m",        # light gray
    TerrainCode.DESERT: "[93m",           # bright yellow
    TerrainCode.VOLCANIC: "[31m",         # red
    TerrainCode.POLAR: "[97m",            # bright white
}

TERRAIN_BG_COLORS: Dict[int, str] = {
    TerrainCode.DEEP_LIQUID: "[44m",      # blue background
    TerrainCode.SHALLOW_LIQUID: "[46m",   # cyan background
    TerrainCode.ICE: "[107m",             # bright white background
    TerrainCode.LOWLAND: "[42m",          # green background
    TerrainCode.PLAINS: "[102m",          # bright green background
    TerrainCode.HIGHLANDS: "[43m",        # yellow background
    TerrainCode.MOUNTAINS: "[47m",        # gray/white background
    TerrainCode.DESERT: "[103m",          # bright yellow background
    TerrainCode.VOLCANIC: "[41m",         # red background
    TerrainCode.POLAR: "[107m",           # bright white background
}
...
def main() -> None:
    ...
    print(f"\n{render_legend(color=args.color, color_style=args.color_style)}\n")
    print(render_ascii(
